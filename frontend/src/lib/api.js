...
export const PRODUCT_STATUSES = ['Pending', 'Designing', 'Offset', 'Digital Printing', 'Printing', 'Binding', 'Ready', 'Delivered'];
...
export const STATUS_COLORS = {
  ...
  Printing: 'bg-fuchsia-100 text-fuchsia-900 dark:bg-fuchsia-900/40 dark:text-fuchsia-200',
